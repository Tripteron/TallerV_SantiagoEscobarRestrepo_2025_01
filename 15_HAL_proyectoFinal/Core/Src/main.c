...
//  uint16_t positions[] = {1000, 1500, 2000};  // 0°, 90°, 180°
//  uint8_t pos_index = 0;

  while (1)
  {
	  /* Movimiento sincronizado de los 3 servos */

	    // Secuencia 1: Todos juntos de 0° a 180°
	    ...
	    // Secuencia 2: Ola (movimiento secuencial)
	    ...
	    // Secuencia 3: Movimiento independiente
	    for(int i = 0; i < 3; i++) {
	      __HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_1, 1000);
	      __HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_2, 1500);
	      __HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_3, 2000);
...
//    __HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_2, positions[pos_index]);
//
//    // Esperar 1 segundo
//    HAL_Delay(1000);
//
//    // Actualizar índice (0,1,2,0,1,2...)
